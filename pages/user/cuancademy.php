<body>
    <div class="container p-5 mt-5">
        <div class="container-fluid" data-aos="fade-up">
            <a href="?page=lesson&subject=1&idlesson=1" target="_blank" class="link-unstyled">
            ...
            <a href="?page=lesson&subject=2&idlesson=1" target="_blank" class="link-unstyled">
                <div class="row p-5 mt-5 mb-5 row-subjects position-relative">
            ...
            <a href="?page=lesson&subject=3&idlesson=1" target="_blank" class="link-unstyled">
                <div class="row p-5 mt-5 mb-5 row-subjects position-relative">
