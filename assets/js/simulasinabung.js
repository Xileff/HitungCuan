...
function hitungSemua(textFields){
    ...
    if (persentasePengeluaran >= 80) {
        ...
        imgHasil.setAttribute('src', 'assets/images/nabung/noob.png');
    ...
    // Lainnya
        ...
        if (persentasePengeluaran >= 50 && persentasePengeluaran < 80) {
            ...
            imgHasil.setAttribute('src', 'assets/images/nabung/intermediate.png');
        ...
        // Jika kurang dari 50%, maka rekomendasi 1 adalah
            ...
            imgHasil.setAttribute('src', 'assets/images/nabung/sultan.png');
