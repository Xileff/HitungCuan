        ...
        <form class="row" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8">
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <input class="form-control montserrat fs-4 w-100 mt-2 mb-4 mx-auto" id="username" placeholder="Username" name="username" pattern="[a-z]{1,51}[0-9]{0,51}" title="Username dimulai dengan huruf kecil, kemudian boleh diikuti dengan angka atau tidak diikuti angka." autocomplete="off" value=""></input>

                    <label for="email" class="montserrat fs-4 w-100 mb-0 mx-auto">Email</label>
                    <input class="form-control montserrat fs-4 w-100 mt-2 mb-4 mx-auto" id="email" placeholder="Email" name="email" type="email" pattern="[a-zA-Z0-9_\-\.]+[\.]{0,2}[a-zA-Z0-9_\-\.]{0,100}[@][a-z]+[\.][a-z]{2,}[\.]{0,2}[a-z]{0,100}[\.]{0,2}[a-z]{0,100}[\.]{0,2}[a-z]{0,100}[\.]{0,2}" title="Masukkan format email yang benar.\nContoh : felix12@gmail.com" autocomplete="off" value=""></input>
                    ...
                    <a href="#" class="text-center montserrat" style="text-decoration: none; ">
                        <p class="hvr-underline-from-left" style="color: rgb(117, 249, 145) !important;">Ganti Password</p>
                    </a>
