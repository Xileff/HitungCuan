<script src="httprequest/request/loadCuancademy.js"></script>

<body>
    <div class="container p-5 mt-5" id="containerCuancademy" data-aos="fade-up">
        <div class="container-fluid">
            <a id="containerSubjectIncome" href="#" class="link-unstyled">
            ...
            <a id="containerSubjectExpenses" href="#" class="link-unstyled">
                <div class="row p-5 mt-5 mb-5 row-subjects position-relative">
            ...
            <a id="containerSubjectInvestment" href="#" class="link-unstyled">
                <div class="row p-5 mt-5 mb-5 row-subjects position-relative">
