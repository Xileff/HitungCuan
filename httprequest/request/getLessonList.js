                ...
                if(response.success == true){
                    $.each(response.lessons, (i, r) => {
                        ...
                        <a href="?page=lesson&subject=${r.id_subject}&idlesson=${r.id}" class="m-4 sidebar-lesson-link fw-bold">
                            <div class="row row-lessons w-100 mx-auto position-relative" style="border-radius: 1rem;">
                                <div class="background-zoom bgLesson w-100 h-100 m-0 p-0 position-absolute start-0 top-0 bg-light"></div>
